...
-- ============================================
-- ROOMS
-- capacity_min / capacity_max reflect the
-- "Minimum of 5 persons" and "3-4 pax" rules
-- from the rate sheet
-- ============================================
...
-- ============================================
-- ROOM RATES
-- Tied to room_type + occupancy item + season
-- from the FY26 rate sheet
-- ============================================
...
-- ============================================
-- FACILITIES
-- All non-room bookable spaces and services
-- ============================================
...
-- ============================================
-- SEED DATA: ROOMS
-- capacity_min/max based on rate sheet rules:
--   Dorm              = min 5, max 10
--   Superior          = min 1, max 4  (1-2 single/double, up to 4 daily max)
--   Standard Apt      = min 1, max 4
--   Deluxe 2BR        = min 1, max 4
--   Deluxe 3BR        = min 1, max 6
-- ============================================
...
-- capacity_min/max added where the rate sheet
-- specifies a person count limit
-- All amounts in Philippine Peso (PHP)
-- ============================================
