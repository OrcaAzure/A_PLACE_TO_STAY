...
export const HERO_CAROUSEL_IMAGES = [
  ...
  LANDING_AMENITY_IMAGE.recreation,
];
...
const AMENITY_TOKENS = {
  ...
  RECREATION_IMG: LANDING_AMENITY_IMAGE.basketballCourt,
  CHAPEL_GARDEN_IMG: LANDING_AMENITY_IMAGE.chapel,
  HERO_CAROUSEL_1: HERO_CAROUSEL_IMAGES[0],
  HERO_CAROUSEL_2: HERO_CAROUSEL_IMAGES[1],
  HERO_CAROUSEL_3: HERO_CAROUSEL_IMAGES[2],
  HERO_CAROUSEL_4: HERO_CAROUSEL_IMAGES[3],
  HERO_CAROUSEL_5: HERO_CAROUSEL_IMAGES[4],
};
...
const VARIANT_TOKENS = {
  public: {
    ...
    GMC_ALT: 'GMC guest room interior',
    GMC_TITLE: 'Rooms',
